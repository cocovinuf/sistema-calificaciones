<header>
    ...
    <div class="container-fluid">
        <div class="row g-3 p-3">
            ...
            <div class="col-xl-2">
                <a class="btn btn-secondary w-100 d-flex justify-content-center align-items-center"
                   href="seleccion_materia_tutores.php">
            ...
            <div class="col-xl-2">
                <a class="btn btn-danger w-100 d-flex justify-content-center align-items-center"
